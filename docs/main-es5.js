...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentsPianoPianoComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    PianoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 2,
      consts: [[1, "container-fluid", "bkg"], ["id", "keyboard", 1, "col-xs-12", "col-md-6", "m-auto"], ["keyboard", ""], ["id", "teclas"], [1, "row"], ["class", "blacks bubbly-button", 3, "id", "click", 4, "ngFor", "ngForOf"], ["class", "whites bubbly-button", 3, "id", "click", 4, "ngFor", "ngForOf"], [1, "blacks", "bubbly-button", 3, "id", "click"], [1, "letras_negras", "mb-0"], [1, "whites", "bubbly-button", 3, "id", "click"], [1, "letras_blancas", "mb-0"]],
