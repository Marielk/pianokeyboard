...
const _c0 = ["keyboard"];
function PianoComponent_div_4_Template(rf, ctx) { if (rf & 1) {
...
class PianoComponent {
    ...
    play() {
        ...
        document.addEventListener('keydown', (e) => {
            ...
            // console.log(keycode);
            const key = this.keyboard.find((code) => { if (Number(code[0]) === keycode) {
                return code;
            } });
            if (key) {
...
PianoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PianoComponent, selectors: [["app-piano"]], viewQuery: function PianoComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 5, vars: 1, consts: [["id", "keyboard"], ["keyboard", ""], [4, "ngFor", "ngForOf"]], template: function PianoComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! C:\Users\lovel\Desktop\Mariel\proyectos practica\piano keyboard\pianokeyboard\piano-keyboard\src\main.ts */"./src/main.ts");
